...
class Trainer:
    ...
    def train_epoch(self, epoch, train_loader, loss_fn, optimizer, metrics, device):
        ...
        for i, (features, label) in enumerate(train_loader):
            ...
            loss.backward() # backprop; need .zero_grad to clear the otherwise accumulated gradient

            optimizer.step() # update a parameter based on the current gradient (stored in .grad attribute of a parameter) and the update rule.
